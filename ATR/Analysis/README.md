...
- `atr_2024_2025_midweek_matches.csv` contains the confident one-to-one matches, including a human-readable `display_name` column for tables and map-ready `latitude`/`longitude` columns.
